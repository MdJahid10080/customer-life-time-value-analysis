...
st.markdown(
    ...
    .result-card {padding: 1.5rem; border-radius: 22px; background: linear-gradient(135deg, #0b1120 0%, #111827 52%, #172554 100%); color: #fff1f5; border: 1px solid #475569; box-shadow: 0 16px 34px rgba(2,6,23,.28);}
